...
import {
  Mail, Lock, Eye, EyeOff, AlertCircle, CheckCircle, Loader2, Building2, Phone, MapPin,
} from "lucide-react";
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (
        ...
        setErrorMessage("Por favor completa nombre de empresa, RUT empresa y email");
        setLoading(false);
        return;
      }
      ...
      // 1️⃣ Buscar o crear ciudad, obtener ciudad_id
      ...
      if (insertError) {
        ...
        setErrorMessage("Error al guardar tu información. Por favor intenta de nuevo.");
        setLoading(false);
        return;
      }
